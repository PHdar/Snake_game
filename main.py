...
class Snake:
    ...
    #     snake body
        self.body_h = pygame.image.load("./graphics/snake/body_horizontal.png").convert_alpha()
        self.body_v = pygame.image.load("./graphics/snake/body_vertical.png").convert_alpha()
...
picture = pygame.image.load("./graphics/apple/apple_00.png").convert_alpha()
apple = pygame.transform.scale(picture,(40,40))
